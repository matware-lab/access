...
class Access
{
	...
	/**
	 * Method to preload the AccessRules object for the given asset type.
	 *
	...
	/**
	 * Method to preload the AccessRules objects for all components.
	 *
	...
	protected static function preloadComponents()
	{
		...
		// Container for all of the AccessRules for this $assetType
		$rulesList = array();
	...
	/**
	 * Method to return the AccessRules object for an asset.  The returned object can optionally hold
	...
	public static function getAssetRules($asset, $recursive = false, $recursiveParentAsset = true)
	{
			...
			&& isset(self::$assetPermissionsByName[$extensionName][$asset]))
		{
			...
			* only one instance of the AccessRules object for
